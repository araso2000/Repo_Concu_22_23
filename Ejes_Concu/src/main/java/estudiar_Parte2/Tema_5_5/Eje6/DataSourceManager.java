package estudiar_Parte2.Tema_5_5.Eje6;
...
public class DataSourceManager {
	...
	public void accessDataSource(int dataSource, String name)  {
		lock.lock();
		
		try {
			System.out.println("DataManager -> Intentando acceder: " + dataSource + name);
			...
			System.out.println("DataManager -> Accedido: " + dataSource + name);
	...
	public int accessAnyDataSource(String name) {
		int indice = 0;
		...
		try {
			...
			System.out.println("DataManager -> Accedido: " + indice + name);
	...
	public void freeDataSource(int dataSource, String name) {
		lock.lock();
		
		try {
			System.out.println("DataManager -> Liberando: " + dataSource + name);
